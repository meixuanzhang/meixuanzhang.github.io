...
**C++的产生和发展**  
![_config.yml]({{ site.baseurl }}/images/C++program decide/image20.jpg)    
...
**C++字符集**  
![_config.yml]({{ site.baseurl }}/images/C++program decide/image21.jpg)    

**词法记号**  

![_config.yml]({{ site.baseurl }}/images/C++program decide/image22.jpg)  
...
![_config.yml]({{ site.baseurl }}/images/C++program decide/image23.jpg)  
...
![_config.yml]({{ site.baseurl }}/images/C++program decide/image24.jpg)   
...
**字符常量**  
![_config.yml]({{ site.baseurl }}/images/C++program decide/image25.jpg)   
...
![_config.yml]({{ site.baseurl }}/images/C++program decide/image26.jpg)  

**通过添加前缀可以改变字符常量或者字符串常量的类型**  

![_config.yml]({{ site.baseurl }}/images/C++program decide/image27.jpg)   
...
**基本算术运算符**    
![_config.yml]({{ site.baseurl }}/images/C++program decide/image28.jpg)    
...
**复合的赋值运算符**  
![_config.yml]({{ site.baseurl }}/images/C++program decide/image29.jpg)    
...
例：x=a>b?a:b  
如果a>b是true,x=a,否则x=b

**条件运算的优先级**    
![_config.yml]({{ site.baseurl }}/images/C++program decide/image30.jpg)    
...
**位运算——按位与(&)**   
![_config.yml]({{ site.baseurl }}/images/C++program decide/image31.jpg)   

**位运算——按位或(|)**  
![_config.yml]({{ site.baseurl }}/images/C++program decide/image32.jpg)    

**位运算——按位异(^)**    
![_config.yml]({{ site.baseurl }}/images/C++program decide/image33.jpg)    

**位运算——取反(~)**   
![_config.yml]({{ site.baseurl }}/images/C++program decide/image34.jpg)    

**位运算——移位(<<、>>)**    
![_config.yml]({{ site.baseurl }}/images/C++program decide/image35.jpg)   

**优先级**   
![_config.yml]({{ site.baseurl }}/images/C++program decide/image36.jpg)  

**混合运算时数据类型的转换——隐含转换**  
+ 一些二元运算符(算术运算符、关系运算符、逻辑运算符、位运算符和赋值运算符)要求两个操作数的类型一致
+ 在算术运算和关系运算中如果参与运算的操作数类型不一致，编译系统会自动对数据进行转换（即隐含转换），基本原则是将低类型数据转换为高类型数据。

+ 将一个非布尔型的算术赋值给布尔型时，算术值为0则结果为false,否则结果为true
+ 将一个布尔值赋给非布尔型时，布尔值为false则结果为0，布尔值为true则结果为1  
+ 将一个浮点数赋给整数型时，结果值将只保留浮点数中的整数部分，小数部分将丢失
+ 将一个整数值赋给浮点型时，小数部分记为0。如果整数所占的空间超过浮点类型的容量，精度可能有损失

![_config.yml]({{ site.baseurl }}/images/C++program decide/image37.jpg)      
![_config.yml]({{ site.baseurl }}/images/C++program decide/image38.jpg)     
