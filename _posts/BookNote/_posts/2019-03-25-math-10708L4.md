...
如上例所示，直观地说，graph elimination过程与variable elimination 算法有着密切的联系。本文首先对graph elimination算法进行了总结，给出了一个重要的图结构重构图的定义，给出了GE中elimination clique与VE中生成的中间项( intermediate term)的对应。
