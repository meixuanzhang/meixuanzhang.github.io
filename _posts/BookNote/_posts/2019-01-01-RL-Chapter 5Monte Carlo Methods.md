...
=\frac{\sum \prod_{k=t}^{T-1}\pi(A_{k}\mid S_{t}) G_{t}}{\sum \prod_{k=t}^{T-1}\pi(A_{k}\mid S_{t})}
$$
...
$$
V_{\pi}(S_{t})=\frac{\sum \prod_{k=t}^{T-1}b(A_{k}\mid S_{t})  \frac{\prod_{k=t}^{T-1}\pi(A_{k}\mid S_{t})}{\prod_{k=t}^{T-1}b(A_{k}\mid S_{t})} G_{t}}{\sum \prod_{k=t}^{T-1}b(A_{k}\mid S_{t})}\\
