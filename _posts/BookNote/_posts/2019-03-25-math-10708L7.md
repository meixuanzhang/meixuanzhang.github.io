...
$$m \left( \mathbf { x } _ { c } \right) = \sum _ { \mathbf { x } _ {-c } } m ( \mathbf { x } )$$  
...
$$
p ( D ; \theta ) = \prod _ { n } \sum _ { x } p ( \mathbf { x } ; \theta ) ^ { \delta \left( \mathbf { x } , \mathbf { x } _ { n } \right) } \\ 
...
=\sum _ { \mathbf { x } _ { c } } m ( \mathbf { x } ) (\sum _ { -\mathbf { x } _ { c } } m ( \mathbf { x } )) \log \left( \frac { 1 } { Z } \prod _ { c } \psi _ { c } \left( \mathbf { x } _ { c } \right) \right) 
