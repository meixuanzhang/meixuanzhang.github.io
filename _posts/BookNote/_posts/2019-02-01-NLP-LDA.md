...
**目前已知每篇文章由哪些词构成，我们希望获得每类文章的词频分布$$\varphi_{k}$$** 
...
$$
L=\sum_{t=1}^N \sum_{k=1}^K \sum_{v=1}^V\pi_{d,t,k}[W_{d,t}==v] log\varphi_{k,v}+ \lambda (\sum_{v=1}^V\varphi_{k,v}-1)
$$


$$
\frac{dL}{d\varphi_{k,v}}=
$$
