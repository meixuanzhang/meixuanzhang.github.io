...
$$
P(Z_{(m,n)}\mid \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})=\frac{P(Z_{(m,n)}, \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})}{P( \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})}\\
$$

$$
P(Z_{(m,n)}=k\mid \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})=\frac{P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})}{ P(\mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})} \propto P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})\\
$$


$$
P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})=\int_{\theta_{m}}\int_{\varphi_{k}}P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m,\theta_{m},\varphi_{k};\mathbf{α},\mathbf{β})d_{\theta_{m}}d_{\varphi_{k}}\\
...
=\int_{\theta_{m}}     P(\theta_{m}\mid \mathbf{Z_{-(m,n)}};\mathbf{α})  \theta_{m,k} d\theta_{m}  \int_{\varphi_{k}}   P(\varphi_{k}\mid \mathbf{W_{-(m,n)}};\mathbf{β})}{\mathbf{W_{-(m,n)}})  \varphi_{k,v} d_{\varphi_{k}}
$$


$$
P(Z_{(m,n)}=k \mid \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β}) \propto \frac{n_{m,(\cdot)}^{k,-(m,n)}+\alpha_{k}}{\sum_{i=1}^K n_{m,(\cdot)}^{i,-(m,n)}+\alpha_{i}}   \frac{n_{(\cdot),(m,n)}^{k,-(m,n)}+\beta_{(m,n)}}{\sum_{v=1}^V n_{(\cdot),v}^{k,-(m,n)}+\beta_{v}}  
$$
