...
我们希望获得每个词对应的主题的Gibbs采样：  

$$
P(Z_{(m,n)}\mid \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})=\frac{P(Z_{(m,n)}, \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})}{P( \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})}\\
$$
...
$$
P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})=
$$
