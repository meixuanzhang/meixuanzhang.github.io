...
=\sum_{H}Q(H;\gamma,\pi,\phi)[log\frac{Q(H;\gamma,\pi)P(W;\mathbf{α},\mathbf{β})}{ P(H,W;\mathbf{α},\mathbf{β})}]\\
=\sum_{H}Q(H;\gamma,\pi,\phi)[log\frac{Q(H;\gamma,\pi)}{ P(H,W;\mathbf{α},\mathbf{β})}+logP(W;\mathbf{α},\mathbf{β})]\\
=\sum_{H}Q(H;\gamma,\pi,\phi)[log\frac{Q(H;\gamma,\pi)}{ P(H,W;\mathbf{α},\mathbf{β})}]+logP(W;\mathbf{α},\mathbf{β})\\
$$
...
=\sum_{H}Q(H;\gamma,\pi,\phi)log P(W,H;\mathbf{α},\mathbf{β})-\sum_{H}Q(H;\gamma,\pi)log Q(H;\gamma,\pi,\phi)\\
=\sum_{H}Q(H;\gamma,\pi,\phi)log P(W,Z,\theta,\varphi;\mathbf{α},\mathbf{β})-\sum_{H}Q(H;\gamma,\pi)log Q(H;\gamma,\pi,\phi)\\
