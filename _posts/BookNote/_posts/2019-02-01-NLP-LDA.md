...
$$
L= \sum_{H}Q(H)log\frac{P(W \mid H;\mathbf{α},\mathbf{β})P(H;\mathbf{α},\mathbf{β})}{Q(H)}\\
=\sum_{H}Q(H)log P(W \mid H;\mathbf{α},\mathbf{β})P(H;\mathbf{α},\mathbf{β})-\sum_{H}Q(H)log Q(H)
$$
