...
$$
P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m;\mathbf{α},\mathbf{β})=\int_{\theta_{m}}\int_{\varphi_{k}}P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W_m,\varphi_{k};\mathbf{α},\mathbf{β})d_{\theta_{m}}d_{\varphi_{k}}\\
