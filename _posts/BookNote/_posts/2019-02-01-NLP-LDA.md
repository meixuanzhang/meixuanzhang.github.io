...
$$
P(Z,W;\mathbf{α},\mathbf{β})=\int_{\varphi}\prod_{k=1}^K P(\varphi_{i};\mathbf{β}))\prod_{d=1}^M \prod_{t=1}^{N{d}}P(W_{d,t}\mid \varphi_{Z_{d,t}})d\varphi  \int_{\theta} \prod_{d=1}^MP(\theta_d;\mathbf{α})\prod_{t=1}^{N{d}}P(Z_{d,t}\mid \theta_{d})d\theta
$$
