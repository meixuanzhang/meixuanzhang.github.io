...
$$
P(Z_{(m,n)}=k\mid \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})=\frac{P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})}{ P(\mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})} \propto P(Z_{(m,n)}=k, \mathbf{Z_{-(m,n)}},W;\mathbf{α},\mathbf{β})\\
$$
