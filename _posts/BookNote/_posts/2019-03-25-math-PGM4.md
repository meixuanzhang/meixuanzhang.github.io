...
=\sum_{s_{1},s_{2}}p(s_{1})p( f_{1} \mid s_{1})p(s_{2})p( f_{2} \mid s_{2})V(f_{1},f_{2},c)\\
= \sum_{s_{1}}p(s_{1})p( f_{1} \mid s_{1})\sum_{s_{2}}p(s_{2})p( f_{2} \mid s_{2}) V(f_{1},f_{2},c)\\
$$  
