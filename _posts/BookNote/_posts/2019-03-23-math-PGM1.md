...
P("cat" appears|Label="Pet")~Bernoulli 

P("Pet"appears|"cat","dog",..)~Bernoulli

Label={Pet,Financial...} 

$$\sum_{Label}P(Label|"cat","dog",..)\ne 1$$  
...
$$
P(W_{1} appears|Label="Pet")\sim Multinomial\\
P(Label appears|W_{1},W_{2}..W_{n})\sim Multinomial
$$

$$\sum_{Label}P(Label\mid W_{1},W_{2}..W_{n})= 1$$   
