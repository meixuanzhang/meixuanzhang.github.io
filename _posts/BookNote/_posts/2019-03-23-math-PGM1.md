...
子图$$K[\widehat{X}]$$所有节点$$x$$及其$$Boundary_{x}$$称为$$\widehat{X}$$的upwardly closure ，定义为minimal upwardly closed set Y，$$K[Y]$$，$$\widehat{X}$$的upwardly closed subgraph 标记为$$K^+[\widehat{X}]$$ (未确定理解对不对)
