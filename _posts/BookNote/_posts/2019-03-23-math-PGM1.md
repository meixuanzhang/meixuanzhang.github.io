...
现已知学生智力低，课程获得高成绩概率降低，获得Letter概率降低（无条件下获得Letter概率，被智商高群体拉高了）。所以式子2在低智力条件下，获得Letter概率降低。   
...
$$
P(x_{1}=1\mid y=1)=\frac{2}{3}\\
P(x_{2}=1\mid y=1)=\frac{2}{3}\\
p(x_{2}=1\mid x_{1}=1)=0.5
$$
