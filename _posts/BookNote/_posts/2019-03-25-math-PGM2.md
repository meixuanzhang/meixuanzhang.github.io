...
## 1、Overview  
 the framework of statistics has defined for us a multitude of different representations of a conditional probability distribution given a set of, of conditioning variables  
 
 This is a, an independent statement that only holds for particular values of the conditioning variable C. 
